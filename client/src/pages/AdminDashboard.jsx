...
import {
  ...
  getAdminCommittees, getAdminAnomalies, reviewAnomaly, getSystemHealth,
} from "../api/adminApi";
...
export default function AdminDashboard() {
  ...
  const trustDist = useMemo(() => {
    const t = stats?.trustDistribution || { high: 0, medium: 0, low: 0 };
    return [
        ...
        {activeNav === "overview" && stats && (
          <div className="ad-content">
            ...
            <div className="ad-kpi-row ad-kpi-row-secondary">
              ...
              <KpiCard icon={ShieldAlert} label="Open Anomalies" value={stats.openAnomalies}
                sub={`${stats.criticalAnomalies} critical`} tone={{ bg: "rgba(244,63,94,.12)", fg: "#FB7185" }} />
                          <KpiCard icon={CheckCircle2} label="Confirmed Payments" value={(stats.confirmedPayments ?? 0).toLocaleString()}
                sub={`${stats.rejectedPayments ?? 0} rejected all-time`} tone={{ bg: "rgba(16,185,129,.12)", fg: "#34D399" }} />
            ...
            <div className="ad-charts-row">
              <div className="ad-chart-card">
                <div className="ad-chart-head">
                  <h3>Member Growth</h3>
                  <span className="ad-chart-chip">Last 6 months</span>
                </div>
                {stats.growth.some((g) => g.members > 0 || g.committees > 0) ? (
                  <ResponsiveContainer width="100%" height={210}>
                    <AreaChart data={stats.growth}>
                      ...
                      <Area type="monotone" dataKey="committees" stroke="#10B981" strokeWidth={2} fill="none" name="New committees" />
                    </AreaChart>
                  </ResponsiveContainer>
                ) : (
            ...
            <div className="ad-bottom-row">
              <div className="ad-chart-card">
                <div className="ad-chart-head"><h3>Member Trust Distribution</h3></div>
                {trustDist.some((d) => d.value > 0) ? (
                  <>
                    <ResponsiveContainer width="100%" height={185}>
                      <PieChart>
                        <Pie data={trustDist} dataKey="value" nameKey="name" innerRadius={46} outerRadius={70} paddingAngle={3} stroke="none">
                          {trustDist.map((e, i) => <Cell key={i} fill={e.color} />)}
                        </Pie>
                        <Tooltip contentStyle={adTooltipStyle} />
                      </PieChart>
                    </ResponsiveContainer>
              ...
              <div className="ad-chart-card">
                <div className="ad-chart-head">
                  <h3>Top Committees by Volume</h3>
                ...
                {committees.length === 0 ? (
                  ...
                  <div className="ad-top-list">
                    {[...committees].sort((a, b) => (b.collected || 0) - (a.collected || 0)).slice(0, 6).map((c) => (
                      <div key={c.id} className="ad-top-item">
          ...
          <div className="ad-content">
            <div className="ad-table-card">
              <div className="ad-table-head">
                ...
                <span className="ad-chart-chip">Live health computed from collections & anomalies</span>
              </div>
